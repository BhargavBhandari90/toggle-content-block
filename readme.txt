...
Easily switch between two distinct content sections (Left & Right) using a toggle button or switch interface.
...
**Features:**
- Preloads both "Left Content" and "Right Content" blocks by default.
- Allows any type of inner blocks inside each section.
- Customizable labels for the toggle switch.
- Flexible styling and responsive design.
...
4. Customize the Left and Right sections with any blocks you want.
